import 'package:auth_project/bloc/auth_bloc.dart';
...
class SignUpScreen extends StatelessWidget {
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      RoundedInputField(
                        errorText: context.watch<SignupBloc>().state.isPhone
                            ? null
  ...
  bool signup(BuildContext context) {
    if (context.read<SignupBloc>().state.isPhone &&
        context.read<SignupBloc>().state.isOKTermsOfUse) {
      return true;
    }
    return false;
  }
